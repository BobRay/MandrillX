...
$packageNameLower = 'mandrillx'; /* No spaces, no dashes */

$components = array(
    /* These are used to define the package and set values for placeholders */
    'packageName' => 'MandrillX',  /* No spaces, no dashes */
    'packageNameLower' => $packageNameLower,
    'packageDescription' => 'MandrillX class for sending email through Mandrill',
    'version' => '1.0.3',
    'release' => 'pl',
    'author' => 'Bob Ray',
    ...
    'packageDocumentationUrl' => 'https://bobsguides.com/mandrillx-class.html',
    'copyright' => '2013-2014',
    ...
    'newSystemSettings' => array(
        'mandrill_api_key' => array( // key
            'key' => 'mandrill_api_key',
            'name' => 'Mandrill API Key',
            'description' => 'Your API key from mandrillapp.com',
            'namespace' => 'mandrillx',
            'xtype' => 'textfield',
            'value' => '',
            'area' => '',
    ...
    */
    ...
    'namespaces' => array(
        'mandrillx' => array(
            'name' => 'mandrillx',
            'path' => '{core_path}components/mandrillx/',
            'assets_path' => '{assets_path}components/mandrillx/',
        ),
